...
public class StoreDriver {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        List<SalesRepresentative> SalesRepresentativeList = new ArrayList<SalesRepresentative>();
        ...
        while (sc.hasNext()) {
            ...
            if (employeeType.equals("Manager")) {
                ...
                SalesRepresentative salesRepresentative = new SalesRepresentative(productName, product,
                        numberOfHoursWorked, hourlyRate, storeDetails, basePay, empName);
        ...
        for (Manager manager : managerList) {
            ...
            pwd.println(manager);
            System.out.println("\nAddress: " + String.format("%s", manager.Address()));
            pwd.println("\nAddress : " + String.format("%s", manager.Address()));
            System.out.println(
            ...
            System.out.println("Total Allowance : $" + String.format("%.1f", manager.calculateAllowance()));
            pwd.println("Total Allowance : $" + String.format("%.1f", manager.calculateAllowance()));
            ...
            pwd.println("Is " + manager.getEmployeeName() + " eligible for promotion? ");
            if (manager.checkPromotionEligibility() == true) {
                System.out.println("Yes, he is \n");
                pwd.println("Yes, he is \n");
            } else {
                System.out.println("No, he needs to work harder\n");
                pwd.println("No, he needs to work harder\n");
            }
            System.out.println("\n");
            pwd.println("\n");
        ...
        for (SalesAssociate salesAssociate : SalesAssociateList) {
            ...
            System.out.println("\nAddress: " + String.format("%s", salesAssociate.Address()));
            pwd.println("\nAddress : " + String.format("%s", salesAssociate.Address()));
            ...
            System.out.println("Total Allowance : $" + String.format("%.1f", salesAssociate.calculateAllowance()));

            pwd.println("Total commission: $" + salesAssociate.calculateCommission());
            pwd.println("Gross Payment: $" + salesAssociate.calculatePay());
            pwd.println("Total Allowance : $" + String.format("%.1f", salesAssociate.calculateAllowance()));

            salesAssociate.Holiday();
            System.out.print("Is " + salesAssociate.getEmployeeName() + " eligible for promotion? ");
            pwd.println("Is " + salesAssociate.getEmployeeName() + " eligible for promotion? ");
        ...
        System.out.println("******************************************************");
        System.out
                .println("Number of employees working as SALES REPRESENTATIVE are: " + SalesRepresentativeList.size());
        System.out.println("******************************************************");
        pwd.println("******************************************************");
        pwd.println("Number of employees working as SALES REPRESENTATIVE are: " + SalesRepresentativeList.size());
        pwd.println("******************************************************");

        for (SalesRepresentative salesRepresentative : SalesRepresentativeList) {
            salesRepresentativeCount++;
            System.out.println(salesRepresentativeCount + ". Sales Representative Details:");
            System.out.println(salesRepresentative);
            pwd.println(salesRepresentative);
            System.out.println("\nAddress: " + String.format("%s", salesRepresentative.Address()));
            pwd.println("\nAddress : " + String.format("%s", salesRepresentative.Address()));
            System.out.println("Total Payment: $" + salesRepresentative.calculatePay());
            pwd.println("Total Payment: $" + salesRepresentative.calculatePay());

            System.out.println("Total Allowance : $" + String.format("%.1f", salesRepresentative.calculateAllowance()));
            pwd.println("Total Allowance : $" + String.format("%.1f", salesRepresentative.calculateAllowance()));

            salesRepresentative.Holiday();
            System.out.print("Is " + salesRepresentative.getEmployeeName() + " eligible for promotion? ");
            pwd.println("Is " + salesRepresentative.getEmployeeName() + " eligible for promotion? ");
            if (salesRepresentative.checkPromotionEligibility() == true) {
                System.out.println("Yes, he/she is eligible\n");
                pwd.println("Yes, he/she is eligible\n");
            } else {
                System.out.println("No, he/she needs to work harder\n");
